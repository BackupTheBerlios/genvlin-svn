...
public class MainPool extends Pool {
     ...
     *
     ...
     throw new UnsupportedOperationException("Please use create(Class) instead!");
     }    */
    
    /**
     * This method will create a new entry.
     * Known entries could be VectorPool, XYPool, DoubleVectorInterface 
     * and VectorInterface.
     * The specified class should implement IDData.
     *
     * @throws UnsupportedOperationException if class not supported!
     */
    public IDData create(Class clazz) {
        IDData o;
        
        /*TODO
        try {
            if(!(Class.forName("de.genvlin.core.data.IDData").
                    isInstance(clazz.newInstance())))
                throw new UnsupportedOperationException("The specified class should " +
                    "implement IDData.");
        ...
        if(clazz.getName().equals("de.genvlin.core.data.XYPool"))
            ...
            //TODO?
            o = new LinearFunction(0,0, new IntID(counter));
        ...
        else throw new UnsupportedOperationException("See" +
                " javadoc which classes are available!");
    ...
    /** TODO: rethink about this here:<br>
     * I hope you know that other instances may still hold references
     * to the vectors! So garbage collector couldn't remove them!
     * This method will only remove the direct access to them!
     * The ID-Counter will not be reseted, because of possible bugs!
     * Please do only use, if you know what you do!
     */
    public void clear() {
        super.clear();
    }
